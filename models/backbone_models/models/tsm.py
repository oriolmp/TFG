...
sys.path.insert(0, os.path.join(dirname,
                                '../../../../../../../../Desktop/E2E-TAD-24a1895d089601da0fc447e659fab63acfed61d4/pretrained_models'))
...
def make_temporal_shift(net, n_div=8, place='blockres'):
    # import torchvision
    # if isinstance(net, torchvision.pretrained_models.ResNet):
    if place == 'block':
...
class TSM(nn.Module):
    ...
    def __init__(self, encoder_config, arch='resnet50', is_shift=True, shift_div=8, shift_place='blockres',
                 temporal_pool=False,
                 freeze_bn=True):
        '''
        ...
        self.arch = encoder_config.tsm_base_model
        ...
        self._freeze_bn_affine = encoder_config.freeze_affine
        self.frozen_stages = encoder_config.frozen_stages
